...
% for i=1:N-1
%     %% Circular trajectory
% %     eta_desired(:,i) = pffield_trajectory(time_vector(i), x_SS_alpha, x_SS_leader(:,i), target_point, obstacles);
%     x_SS_leader_dot = pffield_trajectory(x_SS_leader, target_point, obstacles);
%     
% %     x_SS_leader_dot = [x_ddot;y_ddot;0];
%     
...
%     eta_desired(:,i) = pffield_trajectory(time_vector(i), x_SS_alpha, x_SS_leader(:,i), target_point, obstacles);
      ...
      x_SS_leader_dot = pffield_trajectory(x_SS_leader(:,i), target_point, obstacles);
