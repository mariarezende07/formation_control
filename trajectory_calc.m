...
for i=1:N-1
    ...
    [sigma_2(:,i+1),Q_2(:,i+1),x_SS_2_dot] = subsystem_trajectory_1(2,x_SS_leader(:,i),x_SS_2(:,i),x_SS_3(:,i),x_SS_4(:,i),...
                                                                    lambda_sigma,k_sigma,l_sigma,epsilon_sigma);

    x_SS_2(:,i+1) = x_SS_2(:,i) + dt * x_SS_2_dot;
    
    [sigma_3(:,i+1),Q_3(:,i+1),x_SS_3_dot] = subsystem_trajectory_1(3,x_SS_leader(:,i),x_SS_2(:,i),x_SS_3(:,i),x_SS_4(:,i),...
                                                                    lambda_sigma,k_sigma,l_sigma,epsilon_sigma);

    x_SS_3(:,i+1) = x_SS_3(:,i) + dt * x_SS_3_dot;

    [sigma_4(:,i+1),Q_4(:,i+1),x_SS_4_dot] = subsystem_trajectory_1(4,x_SS_leader(:,i),x_SS_2(:,i),x_SS_3(:,i),x_SS_4(:,i),...
                                                                    lambda_sigma,k_sigma,l_sigma,epsilon_sigma);
