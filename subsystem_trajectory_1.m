...
sigma = [[0,       2*lambda_sigma*x_2 - lambda_sigma*x_1 - lambda_sigma*x_3 - u_1*cos(theta_1) + 2*u_2*cos(theta_2) - u_3*cos(theta_3) - v_1*sin(theta_1) + 2*v_2*sin(theta_2) - v_3*sin(theta_3), 2*lambda_sigma*x_3 - lambda_sigma*x_2 - lambda_sigma*(x_1 + 1) - u_1*cos(theta_1) - u_2*cos(theta_2) + 2*u_3*cos(theta_3) - v_1*sin(theta_1) - v_2*sin(theta_2) + 2*v_3*sin(theta_3)];
[0, 2*lambda_sigma*y_2 - lambda_sigma*y_3 - lambda_sigma*(y_1 - 1) - v_1*cos(theta_1) + 2*v_2*cos(theta_2) - v_3*cos(theta_3) + u_1*sin(theta_1) - 2*u_2*sin(theta_2) + u_3*sin(theta_3),       2*lambda_sigma*y_3 - lambda_sigma*y_2 - lambda_sigma*y_1 - v_1*cos(theta_1) - v_2*cos(theta_2) + 2*v_3*cos(theta_3) + u_1*sin(theta_1) + u_2*sin(theta_2) - 2*u_3*sin(theta_3)];
